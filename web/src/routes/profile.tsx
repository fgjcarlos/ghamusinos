  ...
  return (
    <div style={{ padding: "20px", maxWidth: "600px", margin: "0 auto" }}>
      ...
      <section style={{ marginBottom: "32px" }}>
        ...
        >
          Conectá tu cuenta de Strava para sincronizar automáticamente tus
      ...
      <section>
        ...
        >
          ...
          <li>¿Con qué frecuencia se sincronizan las actividades? Automáticamente cuando se cargan a Strava.</li>
